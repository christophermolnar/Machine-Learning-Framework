...
-Added a Polar calculation to Num (allows us to calculate polar coordinates/angles)
-Split classes into seperate packages (default, junit Testing, machineLearning, userInterface)
-Added jUnit Testing
-Fixed the edit button
-Multiple calculations can be run now
